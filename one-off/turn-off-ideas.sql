/*	
 *	Turn off Ideas integration if you cannot reach the configuration page
 *	
 *	NOTE:  This script defaults to rolling back changes.
 *		To commit changes, set @saveChanges = 1.
 */
declare @saveChanges bit; --set @saveChanges = 1
declare @supportedVersions varchar(1000); select @supportedVersions='10.*, 11.*, 12.*'
...
select @feature_name = 'Innovations.Enabled', @value = 'False'
